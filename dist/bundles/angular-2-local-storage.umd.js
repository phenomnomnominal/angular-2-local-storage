(function (global, factory) {
    ...
    (factory((global['angular-2-local-storage'] = {}),global.ng.core,global.rxjs,global.rxjs.operators));
    ...
    var LocalStorageService = /** @class */ (function () {
        function LocalStorageService(config) {
            ...
            this.errors$ = new rxjs.Observable(( /**
             * @param {?} observer
             * @return {?}
             */function (observer) { return _this.errors = observer; })).pipe(operators.share());
            this.removeItems$ = new rxjs.Observable(( /**
             * @param {?} observer
             * @return {?}
             */function (observer) { return _this.removeItems = observer; })).pipe(operators.share());
            this.setItems$ = new rxjs.Observable(( /**
             * @param {?} observer
             * @return {?}
             */function (observer) { return _this.setItems = observer; })).pipe(operators.share());
            this.warnings$ = new rxjs.Observable(( /**
             * @param {?} observer
             * @return {?}
             */function (observer) { return _this.warnings = observer; })).pipe(operators.share());
        ...
        /** @nocollapse */ LocalStorageService.ngInjectableDef = i0.defineInjectable({ factory: function LocalStorageService_Factory() { return new LocalStorageService(i0.inject(LOCAL_STORAGE_SERVICE_CONFIG, 8)); }, token: LocalStorageService, providedIn: "root" });
